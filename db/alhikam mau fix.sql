...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 05 Apr 2026 pada 18.18
...
INSERT INTO `akun` (`id_akun`, `id_calon_peserta_didik`, `jenis_akun`, `status_akun`, `username`, `email`, `password`, `password_hint`, `telepon`, `kode_akun`, `link_reset`) VALUES
(20, 0, 'Pendaftar', 'Menunggu', 'ini aku nyoba', 'salfaris2708@gmail.com', 'fb2628eb37e4bc3e3e121217aa1c6cc148794a85', 'salman', '0895708824646', 'QIOXCKT4WQEV9WRTA78O3FQBSEDJXRC0OHYY2EGTUQNLRETK8HDKRLBCWZNIHBOE', 'Xt5qkMMhwuzRrC277u1Y2EGzaHU1TvBr4kgbV3yTq16y8hTDpKV4alYS1dHt4PIC');
...
(2, 7, 11, 'PANDUAN TEKNIS PPDB SMP NUSANTARA CIPUNAGARA 2026', 'Download', 'Pastikan telah membaca panduan ini dengan cermat sebelum memulai.', '1774870189_169ca429ff0a91397fcd.pdf', 18, 'pdf', 0.424, 'Publish', '2024-01-21 22:33:37', '2026-04-05 08:05:13'),
...
(9, 10, 14, 'INFORMASI SEKOLAH', 'Download', 'dadwa', '1774946456_41d390e3b64447bd3801.pdf', 2, 'pdf', 0.312, 'Publish', '2026-03-31 08:40:56', '2026-04-05 15:57:49');
...
(10, 7, 11, 'asrama', 'Asrama', '2345', 'Baik', '2022-04-02', 'asrama', '1774892018_62249d6fa40a8e938580.jpeg', 16, 'Publish', '2026-03-11 03:54:02'),
(11, 8, 11, 'lapangan', 'Lapangan', '56789', 'Rusak', '2024-03-09', 'lapangan bola', '1774892093_a93f85f9ff3b6590195e.jpeg', 3, 'Publish', '2026-03-12 05:35:47'),
(12, 5, 11, 'masjid', 'Masjid ', '12345', 'Baik', '2022-01-03', 'masjid habib', '1774891717_93d27ae110e667d14956.jpeg', 3, 'Publish', '2026-03-24 16:10:53'),
(13, 7, 14, 'kelas', 'Kelas', '31313', 'Baik', '2022-01-03', 'adadadw', '1774584337_239287c109c3c25c0f75.jpeg', 19, 'Publish', '2026-03-24 16:11:18');
...
(1, 11, 'ijazah-terakhir', 'Ijazah Terakhir', 'Scan dengan warna yang mudah dibaca dan jelas', 'Wajib', 1, '1774933166_7dd9d1adf523a0a6891a.jpg'),
...
(10, 11, 'informasi-sekolah', 'INFORMASI SEKOLAH', 'Informasi umum sekolah', 3, '1774946428_4f96048a8e2cc32ab07b.png', 'Publish');
...
INSERT INTO `portfolio` (`id_portfolio`, `id_kategori_portfolio`, `id_admin`, `judul_portfolio`, `jenis_portfolio`, `isi`, `gambar`, `hits`, `status_portfolio`, `tanggal_post`, `tanggal`) VALUES
(7, 8, 11, 'Jendela Literasi: Portofolio Karya Tulis Ilmiah dan Gagasan Terstruktur.', 'Portfolio', 'Santri sering membuat karya tulis ilmiah sebagai bentuk latihan berpikir kritis dan sistematis. Karya ini biasanya membahas topik keislaman, pendidikan, atau sosial dengan menggunakan metode penelitian sederhana. Tujuannya untuk melatih kemampuan menulis, menganalisis, serta menyampaikan gagasan secara terstruktur.', '1774528722_b310d6b4de529abf0e85.png', 12, 'Publish', '2026-03-26 12:38:42', '2026-04-05 08:04:42'),
(8, 9, 11, 'Seni Kalam & Hikmah.', 'Portfolio', 'Kaligrafi merupakan salah satu karya seni yang banyak dikembangkan di pesantren. Santri membuat tulisan ayat Al-Qur’an atau kata-kata hikmah dengan berbagai gaya tulisan yang indah. Selain melatih kreativitas, karya ini juga menjadi sarana memperdalam kecintaan terhadap Al-Qur’an.', '1774528964_9fc420f483449b0a1832.png', 5, 'Publish', '2026-03-26 12:42:45', '2026-03-27 06:38:25'),
...
(10, 11, 11, 'Jejak Pena Muda: Merangkai Ide, Menyusun Makna', 'Portfolio', 'Siswa SMP sering membuat karya tulis sederhana seperti laporan, rangkuman, atau makalah dari suatu materi pelajaran. Karya ini bertujuan untuk melatih kemampuan memahami materi, menulis dengan baik, serta menyusun ide secara sistematis.', '1774529692_83212e41ec151bfec52d.png', 1, 'Publish', '2026-03-26 12:54:52', '2026-03-27 03:19:27'),
...
--
ALTER TABLE `download`
  MODIFY `id_download` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `jenis_dokumen`
  MODIFY `id_jenis_dokumen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT untuk tabel `jenjang_pendidikan`
--
ALTER TABLE `jenjang_pendidikan`
  MODIFY `id_jenjang_pendidikan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `kategori_download`
  MODIFY `id_kategori_download` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `kategori_fasilitas`
  MODIFY `id_kategori_fasilitas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `kategori_prestasi`
  MODIFY `id_kategori_prestasi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

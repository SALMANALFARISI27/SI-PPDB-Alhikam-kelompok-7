...
<div class="mailbox-controls">
	<div class="input-group">
		<button type="submit" name="submit" value="Delete" class="btn btn-secondary" title="Hapus Staff"
				...
				foreach ($staff as $staff) { ?>
					<tr>
						...
						<td><?php if ($staff->gambar == "") {
							...
							$img_dipublic = FCPATH . 'assets/upload/staff/thumbs/' . $staff->gambar;
							$img_diluar = FCPATH . '../assets/upload/staff/thumbs/' . $staff->gambar;
							if (!file_exists($img_dipublic) && file_exists($img_diluar)) {
								@copy($img_diluar, $img_dipublic);
							}
							?>
								<img src="<?php echo base_url('assets/upload/staff/thumbs/' . $staff->gambar) ?>"
						...
						<td>
							<small>
								...
								<br><i class="fa fa-calendar-check"></i> <?php echo $staff->tempat_lahir ?>,
								<?php echo $this->website->tanggal_id($staff->tanggal_lahir) ?>

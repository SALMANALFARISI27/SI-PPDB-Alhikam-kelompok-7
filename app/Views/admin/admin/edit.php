<p class="text-right">
	<a href="<?php echo base_url('admin/admin') ?>" class="btn btn-outline-info btn-sm">
...
<?php
echo form_open(base_url('admin/admin/edit/' . $user->id_admin));
echo csrf_field();
?>
...
<div class="form-group row">
	...
	<div class="col-9">
		<a href="<?php echo base_url('admin/admin') ?>" class="btn btn-outline-info">
			<i class="fa fa-arrow-left"></i> Kembali
		</a>

<p class="text-right">
	...
	<a href="<?php echo base_url('admin/gelombang/detail/'.$gelombang->id_gelombang.'/Semua/Semua') ?>" class="btn btn-warning btn-xs mb-1">
      	<i class="fa fa-users"></i> Semua Jenjang (<?php echo $this->website->angka($m_calon_peserta_didik->total_gelombang_status_calon_peserta_didik($id_gelombang,'Semua','Semua')->total); ?>)
      </a>
      ...
      <a href="<?php echo base_url('admin/gelombang/detail/'.$gelombang->id_gelombang.'/Semua/'.$id_jenjang_pendidikan) ?>" class="btn btn-info btn-xs mb-1">
            <i class="fa fa-user-check"></i> <?php echo $judul_jenjang_pendidikan ?> (<?php echo $this->website->angka($m_calon_peserta_didik->total_gelombang_status_calon_peserta_didik($id_gelombang,'Semua',$id_jenjang_pendidikan)->total); ?>)
      </a>
    <?php } ?>
      ...
      <a href="<?php echo base_url('admin/gelombang/detail/'.$gelombang->id_gelombang.'/Menunggu/'.$id_jenjang_pendidikan) ?>" class="btn btn-dark btn-xs mb-1">
      	<i class="fa fa-tasks"></i> Menunggu (<?php echo $this->website->angka($m_calon_peserta_didik->total_gelombang_status_calon_peserta_didik($id_gelombang,'Menunggu',$id_jenjang_pendidikan)->total); ?>)
      </a>
      <a href="<?php echo base_url('admin/gelombang/detail/'.$gelombang->id_gelombang.'/Diterima/'.$id_jenjang_pendidikan) ?>" class="btn btn-success btn-xs mb-1">
      	<i class="fa fa-check-circle"></i> Diterima (<?php echo $this->website->angka($m_calon_peserta_didik->total_gelombang_status_calon_peserta_didik($id_gelombang,'Diterima',$id_jenjang_pendidikan)->total); ?>)
      </a>
      <a href="<?php echo base_url('admin/gelombang/detail/'.$gelombang->id_gelombang.'/Tidak-Diterima/'.$id_jenjang_pendidikan) ?>" class="btn btn-warning btn-xs mb-1">
      	<i class="fa fa-times-circle"></i> Tidak Diterima (<?php echo $this->website->angka($m_calon_peserta_didik->total_gelombang_status_calon_peserta_didik($id_gelombang,'Tidak-Diterima',$id_jenjang_pendidikan)->total); ?>)
      </a>
      <a href="<?php echo base_url('admin/gelombang/detail/'.$gelombang->id_gelombang.'/Diperiksa/'.$id_jenjang_pendidikan) ?>" class="btn btn-secondary btn-xs mb-1">
      	<i class="fa fa-edit"></i> Diperiksa (<?php echo $this->website->angka($m_calon_peserta_didik->total_gelombang_status_calon_peserta_didik($id_gelombang,'Diperiksa',$id_jenjang_pendidikan)->total); ?>)
      </a>
  ...
  <div class="col-md-12">
    <div class="input-group">
      ...
      <a href="<?php echo base_url('admin/gelombang/detail/'.$gelombang->id_gelombang.'/Semua/Semua') ?>" class="btn btn-warning">
      	<i class="fa fa-users"></i> Lihat Semua Jenjang (<?php echo $this->website->angka($m_calon_peserta_didik->total_gelombang_status_calon_peserta_didik($id_gelombang,'Semua','Semua')->total); ?>)
      </a>
    </div>
  </div>
	...
	<tbody>
		...
		<tr>
            ...
            <div class="icheck-primary">
              <input type="checkbox" name="id_calon_peserta_didik[]" value="<?php echo $calon_peserta_didik->id_calon_peserta_didik ?>" id="check<?php echo $i ?>">
              <label for="check<?php echo $i ?>"></label>
            </div>
          </td>
			<td><strong><?php echo $calon_peserta_didik->nama_calon_peserta_didik ?></strong>
				<small>
					<br><span class="text-secondary">Program:</span> <strong><?php echo $calon_peserta_didik->judul_jenjang_pendidikan ?></strong>
					<br><span class="text-secondary">Kode:</span> <strong><?php echo $calon_peserta_didik->kode_calon_peserta_didik ?></strong>
					<br><span class="text-secondary">NIS/NISN:</span> <?php echo $calon_peserta_didik->nis ?>/<?php echo $calon_peserta_didik->nisn ?>
		         
					<br><span class="text-secondary">TTL:</span> <?php echo $calon_peserta_didik->tempat_lahir ?>, <?php echo $this->website->tanggal_id($calon_peserta_didik->tanggal_lahir) ?>
					<br><span class="text-secondary">Kelamin:</span> <?php if($calon_peserta_didik->jenis_kelamin=='L') { echo 'Laki-laki'; }else{ echo 'Perempuan'; } ?>
			...
			<td>
				<!-- <a href="<?php echo base_url('admin/gelombang/review/'.$calon_peserta_didik->slug_calon_peserta_didik) ?>" class="btn btn-success btn-xs mb-1" title="Edit"><i class="fa fa-tasks"></i> Review</a> -->

					<a href="<?php echo base_url('admin/gelombang/dokumen/'.$calon_peserta_didik->slug_calon_peserta_didik) ?>" class="btn btn-info btn-xs mb-1" title="Edit"><i class="fa fa-tasks"></i> Review</a>

			        <a href="<?php echo base_url('admin/gelombang/cetak/'.$calon_peserta_didik->slug_calon_peserta_didik) ?>" class="btn btn-danger btn-xs mb-1" title="Unduh" target="_blank"><i class="fa fa-file-pdf"></i></a>
			        <a href="<?php echo base_url('admin/gelombang/edit_calon_peserta_didik/'.$calon_peserta_didik->slug_calon_peserta_didik) ?>" class="btn btn-warning btn-xs mb-1" title="Edit"><i class="fa fa-edit"></i></a>
        			<?php if($calon_peserta_didik->status_pendaftaran=='Menunggu') { ?>
						<a href="<?php echo base_url('admin/gelombang/delete_calon_peserta_didik/'.$calon_peserta_didik->slug_calon_peserta_didik.'/'.$calon_peserta_didik->id_gelombang) ?>" class="btn btn-secondary btn-xs delete-link mb-1" title="Hapus"><i class="fa fa-trash"></i></a>
					<?php } ?>
			</td>
		</tr>
		<?php $i++; } ?>

...
<p class="text-right">
  <a href="<?php echo base_url('admin/gelombang/detail/'.$calon_peserta_didik->id_gelombang.'/Semua/'.$calon_peserta_didik->id_jenjang_pendidikan) ?>" class="btn btn-outline-info btn-sm">
    <i class="fa fa-arrow-left"></i> Kembali
  </a>
  <a href="<?php echo base_url('admin/gelombang/cetak/'.$calon_peserta_didik->slug_calon_peserta_didik) ?>" class="btn btn-danger btn-sm" target="_blank">
  ...
  <table class="table table-bordered table-sm printer mt-2">
    <thead>
      <tr>
        <th colspan="2" class="bg-secondary text-white text-center">DATA KESEHATAN DAN INFORMASI CALON PESERTA DIDIK LAINNYA</th>
      </tr>
    </thead>
    <tbody>
      <tr>

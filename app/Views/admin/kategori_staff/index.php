			...
			<tr>
				...
				<td class="text-center">
					<?php if ($kategori_staff->gambar == "") {
						...
						?>
						<img src="<?php echo base_url('assets/upload/image/thumbs/' . $kategori_staff->gambar) ?>"
				...
				<td>
					<?php echo $kategori_staff->keterangan ?>
				</td>
				<td class="text-center"><?php if ($staff) {
					echo $staff->total;
				} else {
					echo 0;
				} ?> Staff</td>
				...
				<td class="text-center">
					<a href="<?php echo base_url('admin/kategori_staff/edit/' . $kategori_staff->id_kategori_staff) ?>"
						class="btn btn-secondary btn-sm"><i class="fa fa-edit"></i></a>
					<a href="<?php echo base_url('admin/kategori_staff/delete/' . $kategori_staff->id_kategori_staff) ?>"

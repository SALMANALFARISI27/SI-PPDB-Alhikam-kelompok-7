...
<form action="<?php echo base_url('admin/tautan') ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
<?php 
echo csrf_field(); 
?>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group row">
					...
					<div class="col-9">
						<input type="text" name="nama_tautan" class="form-control" placeholder="Nama tautan" value="<?php echo set_value('nama_tautan') ?>" required>
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-9">
						<input type="url" name="link_tautan" class="form-control" placeholder="Alamat website" value="<?php echo set_value('link_tautan') ?>" required>

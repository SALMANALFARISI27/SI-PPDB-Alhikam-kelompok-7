...
<div class="mailbox-controls">
	<div class="input-group">
		...
		<button type="submit" name="submit" value="Delete" class="btn btn-secondary" title="Hapus Ekstrakurikuler"
					...
					<tr>
						<td class="text-center">
							<div class="icheck-primary">
								<input type="checkbox" name="id_ekstrakurikuler[]"
									value="<?php echo $ekstrakurikuler->id_ekstrakurikuler ?>" id="check_<?php echo $no ?>">
						...
						<td><?php echo $ekstrakurikuler->judul_ekstrakurikuler ?>
							<small>
								<br><i class="fa fa-graduation-cap"></i>

	...
	<tbody>
		...
		foreach ($kategori_prestasi as $kategori_prestasi) {
			...
			<tr>
				...
				<td class="text-center"><?php if ($prestasi) {
					echo $prestasi->total;
				} else {
					echo 0;
				} ?> Prestasi</td>
				...
				<td class="text-center">
					<a href="<?php echo base_url('admin/kategori_prestasi/edit/' . $kategori_prestasi->id_kategori_prestasi) ?>"
						class="btn btn-secondary btn-sm"><i class="fa fa-edit"></i></a>
					<a href="<?php echo base_url('admin/kategori_prestasi/delete/' . $kategori_prestasi->id_kategori_prestasi) ?>"

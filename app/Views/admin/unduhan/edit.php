<form action="<?php echo base_url('admin/unduhan/edit/' . $unduhan->id_unduhan) ?>" method="post"
	...
	<div class="form-group row">
		...
		<div class="col-md-9">
			<input type="text" name="judul_unduhan" class="form-control"
				value="<?php echo $unduhan->judul_unduhan ?>" required>
		</div>
	</div>
	...
	<div class="form-group row">
		...
		<div class="col-md-9">
			<input type="file" name="file" class="form-control" value="<?php echo $unduhan->file ?>">
		</div>
	</div>
	...
	<div class="form-group row">
		...
		<div class="col-md-2">
			<select name="status_unduhan" class="form-control">
				...
				<option value="Draft" <?php if ($unduhan->status_unduhan == "Draft") {
					echo 'selected';
				} ?>>Draft
				</option>
			</select>
	...
	<div class="form-group row">
		...
		<div class="col-md-9">
			<textarea name="isi" class="form-control konten"><?php echo $unduhan->isi ?></textarea>
		</div>
	</div>

...
<form action="<?php echo base_url('admin/jenjang_pendidikan/edit/' . $jenjang_pendidikan->id_jenjang_pendidikan) ?>"
	...
	<div class="form-group row">
		...
		<div class="col-md-10">
			<input type="text" name="judul_jenjang_pendidikan" class="form-control"
				value="<?php echo $jenjang_pendidikan->judul_jenjang_pendidikan ?>" required>
		</div>
	</div>
	...
	<div class="form-group row">
		...
		<div class="col-md-2">
			<select name="status_jenjang_pendidikan" class="form-control">
				...
				<option value="Draft" <?php if ($jenjang_pendidikan->status_jenjang_pendidikan == "Draft") {
					echo 'selected';
				} ?>>Draft</option>
			</select>
	...
	<div class="form-group row">
		...
		<div class="col-md-3">
			<input type="text" name="tanggal_publish" class="form-control tanggal" value="<?php if (isset($_POST['tanggal_publis'])) {
				...
				echo $this->website->tanggal_id($jenjang_pendidikan->tanggal_publish);
			} ?>">
		...
		<div class="col-md-3">
			<input type="text" name="jam" class="form-control jam" value="<?php if (isset($_POST['jam'])) {
				...
				echo date('H:i:s', strtotime($jenjang_pendidikan->tanggal_publish));
			} ?>">
		...
		<div class="col-md-3">
			<input type="number" name="urutan" class="form-control" value="<?php if (isset($_POST['urutan'])) {
				...
				echo $jenjang_pendidikan->urutan;
			} ?>">

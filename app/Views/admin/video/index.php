			...
			<tr>
				...
				<td class="text-center">
					<?php if ($video->gambar == "") {
						...
						?>
						<img src="<?php echo base_url('assets/upload/image/' . $video->gambar) ?>" class="img img-thumbnail">
					<?php } ?>
				</td>
				...
				<td>
					<div class="embed-responsive embed-responsive-16by9">
						<iframe class="embed-responsive-item"
							src="https://www.youtube.com/embed/<?php echo $video->video ?>?rel=0" allowfullscreen></iframe>
					</div>
				</td>
				<td class="text-center">

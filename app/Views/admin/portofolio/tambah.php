...
<form action="<?php echo base_url('admin/portofolio/tambah') ?>" method="post" accept-charset="utf-8"
	...
	<div class="form-group row">
		...
		<div class="col-md-9">
			<input type="text" name="judul_portofolio" class="form-control"
				value="<?php echo set_value('judul_portofolio') ?>" required>
		</div>
	</div>
	...
	<div class="form-group row">
		...
		<div class="col-md-3">
			<input type="text" name="tanggal_publish" class="form-control tanggal" value="<?php if(isset($_POST['tanggal_publish'])) { echo set_value('tanggal_publish'); }else{ echo date('d-m-Y'); } ?>">

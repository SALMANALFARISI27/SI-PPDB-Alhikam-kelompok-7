...
<table class="table table-bordered table-sm" id="example3">
	...
	<tbody>
		<?php
		$no = 1;
		foreach ($link_website as $link_website) {
			?>
			<tr>
				<td class="text-center"><?php echo $no ?></td>
				<td class="text-center">
					<?php if ($link_website->gambar == "") {
						echo '-';
					} else {
						...
						?>
						<img src="<?php echo base_url('assets/upload/image/thumbs/' . $link_website->gambar) ?>"
				...
				<td class="text-center">
					<a href="<?php echo base_url('admin/link_website/edit/' . $link_website->id_link_website) ?>"
						class="btn btn-secondary btn-sm"><i class="fa fa-edit"></i></a>
					<a href="<?php echo base_url('admin/link_website/delete/' . $link_website->id_link_website) ?>"

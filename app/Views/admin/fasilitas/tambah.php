...
<form action="<?php echo base_url('admin/fasilitas/tambah') ?>" method="post" accept-charset="utf-8"
	...
	<div class="form-group row">
		...
		<div class="col-md-9">
			<input type="text" name="judul_fasilitas" class="form-control"
				value="<?php echo set_value('judul_fasilitas') ?>" required>
		</div>
	</div>
	...
	<div class="form-group row">
		...
		<div class="col-md-6">
			<input type="text" name="kode_nomor_fasilitas" class="form-control"
				value="<?php echo set_value('kode_nomor_fasilitas') ?>">
		</div>
	</div>
	...
	<div class="form-group row">
		...
		<div class="col-md-2">
			<input type="text" name="tanggal_fasilitas" class="form-control tanggal"
				value="<?php echo set_value('tanggal_fasilitas') ?>">

...
<form action="<?php echo base_url('admin/portfolio/edit/' . $portfolio->id_portfolio) ?>" method="post"
	...
	<div class="form-group row">
		...
		<div class="col-md-9">
			<input type="text" name="judul_portfolio" class="form-control"
				value="<?php echo $portfolio->judul_portfolio ?>" required>
		</div>
	</div>
	...
	<div class="form-group row">
		...
		<div class="col-md-3">
			<select name="id_kategori_portfolio" class="form-control">
				<?php foreach ($kategori_portfolio as $kategori_portfolio) { ?>
					<option value="<?php echo $kategori_portfolio->id_kategori_portfolio ?>" <?php if ($portfolio->id_kategori_portfolio == $kategori_portfolio->id_kategori_portfolio) {
						   echo 'selected';
					   } ?>>
		...
		<div class="col-md-2">
			<select name="jenis_portfolio" class="form-control">
				...
				<option value="Homepage" <?php if ($portfolio->jenis_portfolio == "Homepage") {
					echo 'selected';
				} ?>>
					Homepage Slider</option>
				<option value="Header" <?php if ($portfolio->jenis_portfolio == "Header") {
					echo 'selected';
				} ?>>Header
					Halaman</option>
				<option value="Pop Up" <?php if ($portfolio->jenis_portfolio == "Pop Up") {
					echo 'selected';
				} ?>>Pop Up
					Homepage</option>
			</select>
		...
		<div class="col-md-2">
			<select name="status_text" class="form-control">
				...
				<option value="Tidak" <?php if ($portfolio->status_text == "Tidak") {
					echo 'selected';
				} ?>>Tidak Aktif
				</option>
			</select>
		...
		<div class="col-md-2">
			<select name="status_portfolio" class="form-control">
				...
				<option value="Draft" <?php if ($portfolio->status_portfolio == "Draft") {
					echo 'selected';
				} ?>>Draft
				</option>
			</select>

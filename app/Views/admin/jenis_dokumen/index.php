			...
			<tr>
				...
				<td class="text-center">
					<?php if ($jenis_dokumen->gambar == "") {
						...
						$img_dipublic = FCPATH . 'assets/upload/image/thumbs/' . $jenis_dokumen->gambar;
						$img_diluar = FCPATH . 'thumbs/' . $jenis_dokumen->gambar;
						if (!file_exists($img_dipublic) && file_exists($img_diluar)) {
							@copy($img_diluar, $img_dipublic);
						}
						?>
						<img src="<?php echo base_url('assets/upload/image/thumbs/' . $jenis_dokumen->gambar) ?>"
				...
				<td class="text-center">
					<a href="<?php echo base_url('admin/jenis_dokumen/edit/' . $jenis_dokumen->id_jenis_dokumen) ?>"
						class="btn btn-secondary btn-sm "><i class="fa fa-edit"></i></a>

					<a href="<?php echo base_url('admin/jenis_dokumen/delete/' . $jenis_dokumen->id_jenis_dokumen) ?>"

        ...
        <div class="card">
          <div class="card-body p-5">
              ...
              <?php }else{ ?>
                  ...
                  <p class="text-center">Sudah punya Akun? <a href="<?php echo base_url('signin') ?>" class="hover">Login di sini</a>. <br>Jika Anda Belum Memiliki Akun, silakan <a href="<?php echo base_url('registrasi/akun') ?>">Buat Akun</a> terlebih dahulu.

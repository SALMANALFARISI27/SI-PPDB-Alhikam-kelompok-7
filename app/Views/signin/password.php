        ...
        <div class="row gx-0 text-center">
          ...
          <div class="col-lg-6">
            <div class="p-3 p-md-7 p-lg-8">
              <p class="lead mb-6 text-start">Halo <strong><?php echo $akun->nama ?></strong>.<br> Silakan ganti password Anda. Password minimal 6 dan maksimal 32 karakter.</p>
              <?php 
              ...
              <?php echo form_open(base_url('signin/password/'.$token_reset),' class=="text-start mb-3"'); ?>
                ...
                <div class="form-floating password-field mb-3">
                  <input type="password" class="form-control" name="password_konfirmasi" placeholder="Konfirmasi Password" id="loginPasswordConfirm" minlength="6" maxlength="32">
                  <span class="password-toggle"><i class="uil uil-eye"></i></span>

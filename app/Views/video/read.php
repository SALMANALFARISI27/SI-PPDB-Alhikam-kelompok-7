        ...
        <div class="blog classic-view mt-n17">
          ...
          <article class="post">
            <div class="card">
              ...
              <figure class="card-img-top overlay overlay-1 hover-scale"><img
                  src="<?php echo base_url('assets/upload/image/' . $video->gambar) ?>"
                  srcset="<?php echo base_url('assets/upload/image/' . $video->gambar) ?> 2x"
                  alt="<?php echo $video->judul ?>"></figure>
              ...
              <div class="card-footer">
                <ul class="post-meta d-flex flex-wrap gap-2 mb-0">
                  <li class="post-date"><i
                      class="uil uil-calendar-alt"></i><span><?php echo $this->website->tanggal_bulan_menit($video->tanggal) ?></span>
                  </li>
                  <li class="post-date"><i class="uil uil-eye"></i><span>Dilihat<?php echo $video->hits ?? 0 ?>
                      kali</span></li>
                </ul>
                <!-- /.post-meta -->
              </div>

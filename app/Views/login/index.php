								...
								<div class="form-group">
									<button type="submit" class="form-control btn submit px-3" style="background-color: black; border-color: black; color: white;">Login</button>
								</div>
								
								<p class="text-center">
									Kembali ke <a href="<?php echo base_url() ?>" style="color: black; font-weight: bold;">Beranda</a> | Lupa Password? <a href="<?php echo base_url('login/lupa') ?>" style="color: black; font-weight: bold;">Reset</a>
								</p>

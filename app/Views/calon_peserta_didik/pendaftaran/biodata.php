      ...
      <div class="col-md-9">
        ...
        <select name="id_jenjang_pendidikan" class="form-control  form-select" required>
          ...
          <?php foreach ($jenjang_pendidikan as $jenjang_pendidikan) { ?>
            <option value="<?php echo $jenjang_pendidikan->id_jenjang_pendidikan ?>" <?php if (set_value('id_jenjang_pendidikan') == $jenjang_pendidikan->id_jenjang_pendidikan) {
                 echo 'selected';
               } ?>>
    ...
    <div class="form-group row mb-3">
      ...
      <div class="col-md-9">
        <input type="text" name="nama_calon_peserta_didik" class="form-control form-control-lg"
          placeholder="Nama lengkap Calon Peserta Didik" value="<?php echo set_value('nama_calon_peserta_didik') ?>"
          required>
    ...
    <div class="form-group row mb-3">
      ...
      <div class="col-md-5">
        <input type="text" name="nisn" class="form-control"
          placeholder="Nomor Induk Calon Peserta Didik Nasional (NISN)" value="<?php echo set_value('nisn') ?>">
    ...
    <div class="form-group row mb-3">
      ...
      <div class="col-md-3">
        ...
        <select name="id_agama" class="form-control form-select" required>
          <?php foreach ($agama as $agama) { ?>
            <option value="<?php echo $agama->id_agama ?>" <?php if (set_value('id_agama') == $agama->id_agama) {
                 echo 'selected';
               } ?>>
      ...
      <div class="col-md-3">
        <select name="status_wn" class="form-control form-select" required>
          ...
          <option value="WNA" <?php if (set_value('status_wn') == 'WNA') {
            echo 'selected';
          } ?>>WNA</option>
        </select>
      </div>
      <div class="col-md-3">
        <input type="text" name="negara_asal" class="form-control" value="<?php echo set_value('negara_asal') ?>"
    ...
    <div class="form-group row mb-3">
      ...
      <div class="col-md-9">
        <select name="jenis_kelamin" class="form-control form-select" required>
          ...
          <option value="L" <?php if (set_value('jenis_kelamin') == 'L') {
            echo 'checked';
          } ?>>Laki-laki</option>
          <option value="P" <?php if (set_value('jenis_kelamin') == 'P') {
            echo 'selected';
          } ?>>Perempuan</option>
        </select>
      </div>
    ...
    <div class="form-group row mb-3">
      ...
      <div class="col-md-9">
        <input type="text" name="kode_pos" class="form-control" placeholder="Kode Pos"
          value="<?php echo set_value('kode_pos') ?>">
      </div>
    </div>
      ...
      <div class="col-md-9">
        ...
        <div class="form-group">
          <div class="form-check">
            <input class="form-check-input" type="radio" name="jenis_calon_peserta_didik" value="Langsung" <?php if (set_value('jenis_calon_peserta_didik') == 'Tidak') {
              echo 'checked';
            } else {
              echo 'checked';
            } ?>>
          ...
          <div class="form-check">
            <input class="form-check-input" type="radio" name="jenis_calon_peserta_didik" value="Pindahan" <?php if (set_value('jenis_calon_peserta_didik') == 'Pindahan') {
              echo 'checked';
            } ?>>
    ...
    <div class="form-group row mb-3">
      ...
      <div class="col-md-9">
        <input type="text" name="asal_sekolah" class="form-control" placeholder="Nama Sekolah Asal"
          value="<?php echo set_value('asal_sekolah') ?>">
      </div>
    </div>
    ...
    <div class="form-group row mb-3">
      ...
      <div class="col-md-9">
        <textarea name="alamat_sekolah_asal" class="form-control"
          placeholder="Alamat Sekolah Asal"><?php echo set_value('alamat_sekolah_asal') ?></textarea>
      </div>
    </div>
    ...
    <div class="form-group row mb-3">
      ...
      <div class="col-md-9">
        <input type="text" name="tanggal_pindah" class="form-control tanggal" placeholder="Tanggal pindah"
          value="<?php echo set_value('tanggal_pindah') ?>">
  ...
  <div class="card-body">
    ...
    <div class="form-group row mb-3">
      ...
      <div class="col-md-9">
        <select name="goldar_calon_peserta_didik" class="form-control  form-select" required>
          ...
          <option value="A" <?php if (set_value('goldar_calon_peserta_didik') == 'A') {
            echo 'selected';
          } ?>>A</option>
          <option value="B" <?php if (set_value('goldar_calon_peserta_didik') == 'B') {
            echo 'selected';
          } ?>>B</option>
          <option value="AB" <?php if (set_value('goldar_calon_peserta_didik') == 'AB') {
            echo 'selected';
          } ?>>AB</option>
          <option value="O" <?php if (set_value('goldar_calon_peserta_didik') == 'O') {
            echo 'selected';
          } ?>>O</option>
        </select>
      </div>
    ...
    <div class="form-group row mb-3">
      ...
      <div class="col-md-4">
        <input type="number" name="tinggi" class="form-control" placeholder="Tinggi Badan"
          value="<?php echo set_value('tinggi') ?>" required>
    ...
    <div class="form-group row mb-3">
      ...
      <div class="col-md-9">
        <textarea name="penyakit_calon_peserta_didik" class="form-control"
          placeholder="Penyakit yang pernah/sedang diderita Calon Peserta Didik"><?php echo set_value('penyakit_calon_peserta_didik') ?></textarea>
      </div>
    </div>
    ...
    <div class="form-group row mb-3">
      ...
      <div class="col-md-9">
        <textarea name="hobi_calon_peserta_didik" class="form-control"
          placeholder="Hobi CALON PESERTA DIDIK"><?php echo set_value('hobi_calon_peserta_didik') ?></textarea>
      </div>
    </div>
    ...
    <div class="form-group row mb-3">
      ...
      <div class="col-md-9">
        ...
        <div class="form-group">
          <div class="form-check">
            <input class="form-check-input" type="radio" name="berkebutuhan_khusus" value="Tidak" <?php if (set_value('berkebutuhan_khusus') == 'Tidak') {
              echo 'checked';
            } else {
              echo 'checked';
            } ?>>
          ...
          <div class="form-check">
            <input class="form-check-input" type="radio" name="berkebutuhan_khusus" value="Ya" <?php if (set_value('berkebutuhan_khusus') == 'Ya') {
              echo 'checked';
            } ?>>
    ...
    <div class="form-group row mb-3">
      ...
      <div class="col-md-9">
        <textarea name="isi" class="form-control"
          placeholder="Deskripsi Ringkas Tentang Calon Peserta Didik"><?php echo set_value('isi') ?></textarea>
    ...
    <div class="form-group row mb-3">
      ...
      <div class="col-md-9">
        ...
        <select name="id_agama_ayah" class="form-control  form-select">
          ...
          <?php foreach ($agama as $agama) { ?>
            <option value="<?php echo $agama->id_agama ?>" <?php if (set_value('id_agama_ayah') == $agama->id_agama) {
                 echo 'selected';
               } ?>>
              <?php echo $agama->nama_agama ?>
            </option>
      ...
      <div class="col-md-9">
        ...
        <select name="id_pekerjaan_ayah" class="form-control form-select" required>
          ...
          <?php foreach ($pekerjaan as $pekerjaan) { ?>
            <option value="<?php echo $pekerjaan->id_pekerjaan ?>" <?php if (set_value('id_pekerjaan_ayah') == $pekerjaan->id_pekerjaan) {
                 echo 'selected';
               } ?>>
      ...
      <div class="col-md-9">
        ...
        <select name="id_jenjang_ayah" class="form-control  form-select">
          ...
          <?php foreach ($jenjang as $jenjang) { ?>
            <option value="<?php echo $jenjang->id_jenjang ?>" <?php if (set_value('id_jenjang_ayah') == $jenjang->id_jenjang) {
                 echo 'selected';
               } ?>>
    ...
    <div class="form-group row mb-3">
      ...
      <div class="col-md-9">
        <input type="text" name="telepon_ayah" class="form-control" placeholder="Telepon/HP Ayah"
          value="<?php echo set_value('telepon_ayah') ?>" required>
      </div>
    </div>
    ...
    <div class="form-group row mb-3">
      ...
      <div class="col-md-9">
        ...
        <select name="id_agama_ibu" class="form-control  form-select">
          <option value="">Pilih Agama</option>
          <?php foreach ($agama as $agama) { ?>
            <option value="<?php echo $agama->id_agama ?>" <?php if (set_value('id_agama_ibu') == $agama->id_agama) {
                 echo 'selected';
               } ?>>
              <?php echo $agama->nama_agama ?>
            </option>
    ...
    <div class="form-group row mb-3">
      ...
      <div class="col-md-9">
        ...
        <select name="id_pekerjaan_ibu" class="form-control  form-select" required>
          <option value="">Pilih Pekerjaan</option>
          <?php foreach ($pekerjaan as $pekerjaan) { ?>
            <option value="<?php echo $pekerjaan->id_pekerjaan ?>" <?php if (set_value('id_pekerjaan_ibu') == $pekerjaan->id_pekerjaan) {
                 echo 'selected';
               } ?>>
              <?php echo $pekerjaan->nama_pekerjaan ?>
            </option>
    ...
    <div class="form-group row mb-3">
      ...
      <div class="col-md-9">
        ...
        <select name="id_jenjang_ibu" class="form-control  form-select">
          <option value="">Pilih Jenjang Pendidikan</option>
          <?php foreach ($jenjang as $jenjang) { ?>
            <option value="<?php echo $jenjang->id_jenjang ?>" <?php if (set_value('id_jenjang_ibu') == $jenjang->id_jenjang) {
                 echo 'selected';
               } ?>>
              <?php echo $jenjang->nama_jenjang ?>
            </option>
    ...
    <div class="form-group row mb-3">
      ...
      <div class="col-md-9">
        <input type="text" name="telepon_ibu" class="form-control" placeholder="Telepon/HP Ibu"
          value="<?php echo set_value('telepon_ibu') ?>" required>
      </div>
    </div>
      ...
      <div class="form-group row mb-3">
        ...
        <div class="col-md-9">
          ...
          <select name="id_agama_wali" class="form-control form-select">
            <option value="">Pilih Agama</option>
            <?php foreach ($agama as $agama) { ?>
              <option value="<?php echo $agama->id_agama ?>" <?php if (set_value('id_agama_wali') == $agama->id_agama) {
                   echo 'selected';
                 } ?>>
                <?php echo $agama->nama_agama ?>
              </option>
      ...
      <div class="form-group row mb-3">
        ...
        <div class="col-md-9">
          ...
          <select name="id_pekerjaan_wali" class="form-control form-select">
            <option value="">Pilih Pekerjaan</option>
            <?php foreach ($pekerjaan as $pekerjaan) { ?>
              <option value="<?php echo $pekerjaan->id_pekerjaan ?>" <?php if (set_value('id_pekerjaan_wali') == $pekerjaan->id_pekerjaan) {
                   echo 'selected';
                 } ?>>
                <?php echo $pekerjaan->nama_pekerjaan ?>
              </option>
      ...
      <div class="form-group row mb-3">
        ...
        <div class="col-md-9">
          ...
          <select name="id_jenjang_wali" class="form-control form-select">
            <option value="">Pilih Jenjang Pendidikan</option>
            <?php foreach ($jenjang as $jenjang) { ?>
              <option value="<?php echo $jenjang->id_jenjang ?>" <?php if (set_value('id_jenjang_wali') == $jenjang->id_jenjang) {
                   echo 'selected';
                 } ?>>
                <?php echo $jenjang->nama_jenjang ?>
              </option>

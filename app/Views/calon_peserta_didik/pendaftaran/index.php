<?php if($calon_peserta_didik) { ?>
	...
	<tbody>
		...
		<tr>
			...
			<td><strong><?php echo $calon_peserta_didik->nama_calon_peserta_didik ?></strong>
				<small>
					...
					<br><span class="text-secondary">NIS/NISN:</span> <?php echo $calon_peserta_didik->nis ?>/<?php echo $calon_peserta_didik->nisn ?>
		          	<br><span class="text-secondary">Panggilan:</span> <?php echo $calon_peserta_didik->nama_panggilan ?>
			...
			<td>
					<a href="<?php echo base_url('calon_peserta_didik/pendaftaran/dokumen/'.$calon_peserta_didik->slug_calon_peserta_didik) ?>" class="btn btn-info btn-xs mb-1" title="Edit"><i class="fa fa-upload"></i> Unggah Dokumen</a>

			        <a href="<?php echo base_url('calon_peserta_didik/pendaftaran/unduh/'.$calon_peserta_didik->slug_calon_peserta_didik) ?>" class="btn btn-danger btn-xs mb-1" title="Unduh" target="_blank"><i class="fa fa-file-pdf"></i> Unduh</a>
			        <a href="<?php echo base_url('calon_peserta_didik/pendaftaran/edit/'.$calon_peserta_didik->slug_calon_peserta_didik) ?>" class="btn btn-warning btn-xs mb-1" title="Edit"><i class="fa fa-edit"></i></a>
        			<?php if($calon_peserta_didik->status_pendaftaran=='Menunggu') { ?>
						<a href="<?php echo base_url('calon_peserta_didik/pendaftaran/delete/'.$calon_peserta_didik->slug_calon_peserta_didik) ?>" class="btn btn-secondary btn-xs delete-link mb-1" title="Hapus"><i class="fa fa-trash"></i></a>
					<?php } ?>
			</td>
		</tr>
		<?php $i++; } ?>

        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <?php } else { ?>
                        <img src="<?php echo base_url('assets/upload/image/' . $gelombang->gambar) ?>"
                ...
                <div class="col-md-9">
                    ...
                    <p>
                        ...
                        <br><span class="text-dark fw-bold">Pembukaan:</span>
                        <?php echo $this->website->hari($gelombang->tanggal_buka) ?>
                        <br><span class="text-dark fw-bold">Penutupan:</span>
                        <?php echo $this->website->hari($gelombang->tanggal_tutup) ?>
                        <br><span class="text-dark fw-bold">Pengumuman:</span>
                        <?php echo $this->website->hari($gelombang->tanggal_pengumuman) ?>
                    </p>
                    <p>
                        <button type="button" class="btn btn-primary btn-sm rounded text-white mb-1" data-toggle="modal"

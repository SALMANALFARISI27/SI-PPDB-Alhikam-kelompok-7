  ...
  <div class="container pt-12 pt-md-14 pb-13 pb-md-15">
    ...
    <div class="row grid-view gx-md-8 gx-xl-10 gy-8 gy-lg-0">
      ...
      <div class="col-md-4">
        <div class="card">
          <div class="card-body">
            <img src="<?php echo base_url('assets/upload/image/' . $prestasi->gambar) ?>"
              ...
              <table class="table table-bordered tabelku">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo $prestasi->hits ?> Kali</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div class="card">
              <figure class="card-img-top">
                <a href="<?php echo base_url('prestasi/read/' . $prestasi->slug_prestasi) ?>">
                  <img class="img-fluid" src="<?php echo base_url('assets/upload/image/' . $prestasi->gambar) ?>"
                    srcset="<?php echo base_url('assets/upload/image/' . $prestasi->gambar) ?> 2x"
                    alt="<?php echo $prestasi->judul_prestasi ?>" />
                </a>
              </figure>
